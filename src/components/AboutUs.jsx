    ...
    <>
      ...
      <section className="bg-white py-8 px-2 md:px-16" id="about">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          {/* Text Content */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 border-l-4 border-[#3E4227] pl-4">
      ...
      <section className="bg-white py-16 px-6 md:px-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-[#3E4227] rounded-xl shadow-lg p-8 text-center text-white">
          ...
          <div>
            <h3 className="text-3xl font-bold text-black mb-4 border-l-4 border-[#3E4227] pl-3">
            ...
            <div className="flex flex-wrap gap-6">
              <div className="bg-[#7d7d75] text-white rounded-full px-6 py-4 text-center shadow">
